...
# Config & cache paths
# ──────────────────────────────────────────────────────────────────────────────
DOC_KWS_CACHE     = BASE_DIR / "testing_class.pkl"       # your per‐doc training kws + scores
...
# ──────────────────────────────────────────────────────────────────────────────
def main():
    docs = ["I am a huge hockey fan! I love when the playoffs start because I go and buy a video card to upgrade my TV to watch high-performance games", 
           "It's time for me to upgrade my TV and PC components so my family won't think I am a disappointment."]
    print(global_terms)
    test_scores = score_and_cache_test_docs(docs)
