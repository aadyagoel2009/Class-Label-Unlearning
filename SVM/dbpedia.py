...
def prepare_dbpedia14(limit_train: int = None, limit_test: int = None, seed: int = 42):
    """
    DBpedia-14 (train/test provided). Labels are 0..13.
    """
...
def main():
    train_docs, test_docs, y_train, y_test = prepare_dbpedia14()
